...
The lab is currently collecting data for the **Analyses to Reveal Trajectories and Early Markers of Imminent Shifts in Suicidal States** ([ARTEMIS](https://artemis-study.org)) Study as well as being involved in the **Enhancing Neuroimaging Genetics through Meta/Mega Analysis (ENIGMA)** Schizophrenia ([ENIGMA Working Groups](https://enigma.ini.usc.edu/ongoing/))
